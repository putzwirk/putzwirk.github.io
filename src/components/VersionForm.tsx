...
export default function VersionForm({ modId, initial, onSubmit, onCancel }: Props) {
  ...
  const [references, setReferences] = useState<Array<{ id: string; title: string; detail: string }>>([]);
